...
<!-- My scripts -->
	...
	<script type="text/javascript" src="${context}/static/js/doctor/home/datePickerConfig.js"></script>
	<script type="text/javascript" src="${context}/static/js/doctor/home/dataTableConfig.js"></script>
