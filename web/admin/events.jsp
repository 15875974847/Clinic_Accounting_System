...
<!-- My scripts -->
	...
	<script type="text/javascript" src="${context}/static/js/admin/events/dataTableConfig.js"></script>
	<script type="text/javascript" src="${context}/static/js/admin/events/datePickerConfig.js"></script>
