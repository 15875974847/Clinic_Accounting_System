...
<!-- My scripts -->
	<script type="text/javascript" src="${context}/static/js/doctor/my_appointments/dataTablesConfig.js"></script>
	...
	<div class="modal fade" id="closeAppointmentModal" tabindex="-1" role="dialog" aria-labelledby="closeAppointmentModalLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form action = "closeAppointmentAndLeaveANote" method = "post">
