...
<html lang="en">
  <head>
	...
	<script type="text/javascript" src="${context}/static/js/doctor/pers_info/datePickerConfig.js"></script>
	<script type="text/javascript" src="${context}/static/js/doctor/pers_info/validators.js"></script>
	...
	<div class="modal fade" id="editPersonalInfoModal" tabindex="-1" role="dialog" aria-labelledby="editPersonalInfoLabel" aria-hidden="true">
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form id="editPersonalInfoForm" action = "editPersonalInfo" method = "post">
