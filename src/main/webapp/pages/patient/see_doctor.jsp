...
<!-- My scripts -->
	...
	<script type="text/javascript" src="${context}/static/js/patient/see_doctor/dataTableConfig.js"></script>
	<script type="text/javascript" src="${context}/static/js/patient/see_doctor/datePickerConfig.js"></script>
