...
<!-- My scripts -->
	...
	<script type="text/javascript" src="../js/admin/patients/dataTableConfig.js"></script>
	<script type="text/javascript" src="../js/admin/patients/datePickerConfig.js"></script>
