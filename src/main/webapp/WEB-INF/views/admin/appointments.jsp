...
<!-- My scripts -->
	...
	<script type="text/javascript" src="../js/admin/appointments/dataTableConfig.js"></script>
	<script type="text/javascript" src="../js/admin/appointments/datePickerConfig.js"></script>
