...
<!-- My scripts -->
	...
	<script type="text/javascript" src="../js/admin/doctors/dataTableConfig.js"></script>
	<script type="text/javascript" src="../js/admin/doctors/datePickerConfig.js"></script>
                ...
                <tbody>
					<c:forEach var="doctor" items="${requestScope.doctors}">
						<tr>
							...
							<td>${doctor.staffEntity.userInfo.dateOfBirth}</td>
							<td>${doctor.staffEntity.userInfo.phone}</td>
							<td>${doctor.staffEntity.userInfo.email}</td>
							<td>${doctor.staffEntity.userInfo.address}</td>
