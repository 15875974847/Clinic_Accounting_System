...
public class SeeDoctorPageServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.getRequestDispatcher("/pages/patient/see_doctor.jsp").forward(request, response);
        } catch (SQLException e) {
            log.error("500: SQLException at patient/see_doctor/SeeDoctorPageServlet: " + e.getMessage());
